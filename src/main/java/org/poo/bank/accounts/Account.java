...
import org.poo.bank.commerciants.ClothesCoupon;
import org.poo.bank.commerciants.DiscountCoupon;
import org.poo.bank.commerciants.FoodCoupon;
import org.poo.bank.commerciants.TechCoupon;
...
public abstract class Account implements Visitable {
    ...
    public Account() {
        ...
        availableCoupons.add(new FoodCoupon());
        availableCoupons.add(new ClothesCoupon());
        availableCoupons.add(new TechCoupon());
